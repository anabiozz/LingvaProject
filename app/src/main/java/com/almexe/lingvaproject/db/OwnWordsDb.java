...
public class OwnWordsDb {
	...
	public static String   foregin;
	
	public static final String FOREGIN_WORD = "foregin_words";
	public static final String NATIV_WORD =    "nativ_words";
	public static final String TRANSCRIPTION =  "transcription";
	public static final String TABLE =         "ownwords";
	public static final String DB_NAME =       "OwnWordsDb";
	...
	public static final String SQL_CREATE_TABLE = 
			"CREATE TABLE ownwords (" + 
				    "_id INTEGER PRIMARY KEY AUTOINCREMENT, " + 
				    "transcription VARCHAR(200), " + 
				    "foregin_words VARCHAR(200), " + 
				    "nativ_words VARCHAR(200)" +
					")";
	public static final String SQL_DROP_TABLE = 
			"DROP TABLE IF EXISTS ownwords";
	...
	public OwnWordsDb(Context context) {
		mContext = context;
	}
    ...
    public boolean isRowExists(String word) {
        ...
        if(cursor.moveToFirst()) {
            do{
                ...
                if(foregin_word10.equals(word) || nativ_word10.equals(word)){
                    result = true;
                }
